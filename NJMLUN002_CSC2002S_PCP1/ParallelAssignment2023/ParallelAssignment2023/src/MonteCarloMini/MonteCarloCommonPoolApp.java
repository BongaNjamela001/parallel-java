...
class MonteCarloCommonPoolApp {
    ...
    public static void main(String[] args) {
        ...
        MonteCarloCommonPool task = new MonteCarloCommonPool(
            searches, 0, num_searches);
        min = ForkJoinPool.commonPool().invoke(task);
        tock();
		...
		/* Results*/
		System.out.printf("Global minimum: %d at x=%.1f y=%.1f\n\n", min, terrain.getXcoord(searches[MonteCarloCommonPool.getFinder()].getPos_row()), terrain.getYcoord(searches[MonteCarloCommonPool.getFinder()].getPos_col()) );
